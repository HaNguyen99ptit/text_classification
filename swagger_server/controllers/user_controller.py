...
from swagger_server import util # If you only run this file ("user_controller" as an app flask), please comment this line 
...
working_dir  = "C:/Users/Lenovo/Documents/thucTapViettelHe_2021/classificationText"
config = RobertaConfig.from_pretrained(
    working_dir +"/PhoBERT_base_transformers/config.json", from_tf=False, num_labels = 2, output_hidden_states=False,)

model = BertForSequenceClassification.from_pretrained( 
   working_dir +  "/PhoBERT_base_transformers/checkpoint.pth",
    config=config
)
...
def pass_message(enter=None):  # noqa: E501
    """enter message
